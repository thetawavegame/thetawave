/// Expose an arcade plugin that no-ops when the platform does not support the extra inputs.
#[cfg(feature = "arcade")]
pub use arcade_impl::ArcadePlugin;

#[cfg(not(feature = "arcade"))]
pub use null_arcade_impl::ArcadePlugin;
#[cfg(feature = "arcade")]
mod arcade_impl {
    use bevy::prelude::*;
    use bevy_serialport::{
...
/// No-op arcade implementation for unsupported platforms.
mod null_arcade_impl {
    use bevy::prelude::*;
